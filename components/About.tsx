  ...
  return (
    <motion.div
        ...
        <motion.div
            ...
            <p className='text-base text-bruh-gray'>I&apos;m a 17 year old college student living in New Delhi, India. I&apos;m a front-end developer that uses React.js and Next.js. I&apos;m also proficient in programming in Python and Php.</p>
            <SocialIcon 
