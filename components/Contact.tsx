...
export default function Contact({}: Props) {
    return (
        ...
        className='h-screen relative flex flex-col text-center md:text-left md:flex-row max-w-7xl px-10 justify-evenly mx-auto items-center'>
            <h3 className='absolute top-24 uppercase tracking-[20px] text-[#A69C94] text-xl -mr-[20px]'>Contact Me</h3>
            <div className='flex flex-col space-y-10'>
                ...
                viewport={{
                    ...
                    <h4 className='text-3xl font-semibold text-center underline decoration-[#D9C9BA]'>
                        Get in touch
                    </h4>
                    <div className='flex flex-items-center space-x-5 justify-center'>
                        <EnvelopeIcon className='text-[#A6775B] h-7 w-7 animate-pulse'/>
                        <p className='text-xl text-[#D9C9BA]'>namanchandok1@gmail.com</p>
                    </div>
                    <div className='flex flex-items-center space-x-5 justify-center'>
                        <MapPinIcon className='text-[#A6775B] h-7 w-7 animate-pulse'/>
                        <p className='text-xl text-[#D9C9BA]'>New Delhi, India</p>
                    </div>
                </motion.div>
                <motion.div
                initial={{
                ...
                className='flex flex-items-center space-x-4 justify-center text-[#A69C94]'>
                    <SocialIcon 
