            ...
            className='py-16 flex flex-col text-center md:text-left max-w-7xl px-10 space-y-8 mx-auto items-center'>
                ...
                <motion.div
                    ...
                    <div className='group relative px-2 cursor-pointer w-max mx-auto'>
                        <Link href='mailto:namanchandok1@gmail.com' className='text-[#333533] z-20 relative group-hover:text-bruh-black transition duration-300 '>namanchandok1@gmail.com</Link>
                        <div className='absolute bg-bruh-gray/70 transition-all duration-200 h-1.5 group-hover:h-4 bottom-1 inset-x-0 z-0'></div>
                    </div>
                    <div className='group relative px-2 cursor-pointer w-max mx-auto'>
                        <p className='text-[#333533] z-20 relative group-hover:text-bruh-black transition duration-300'>New Delhi, India</p>
                        <div className='absolute bg-bruh-gray/70 transition-all duration-200 h-1.5 group-hover:h-4 bottom-1 inset-x-0 z-0'></div>
                    </div>
                </motion.div>
        </motion.div>
